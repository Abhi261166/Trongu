...
struct UserDefaultsCustom {
    ...
    static var deviceToken: String {
        get {
            return UserDefaults.standard.string(forKey: UserDefaultsCustom.deviceTokenKey) ?? "12345678"
        } set {
    ...
    static var profilePic: String? {
        get {
            return UserDefaults.standard.string(forKey: UserDefaultsCustom.profilePic ?? "")
        } set {
            return UserDefaults.standard.setValue(newValue, forKey: UserDefaultsCustom.profilePic ?? "")
        }
    }
    
    static var fbToken: String? {
        get {
            return UserDefaults.standard.string(forKey: UserDefaultsCustom.fbToken ?? "")
        } set {
            return UserDefaults.standard.setValue(newValue, forKey: UserDefaultsCustom.fbToken ?? "")
        }
    }
