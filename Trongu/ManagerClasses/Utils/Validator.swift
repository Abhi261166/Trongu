...
class Validator {
    ...
    static public func validateName(name: String) -> (Bool,String) {
        ...
        guard trimmedFullName.count <= maxLength   else {
            return (false, "Please enter at maximum 30 Characters for name")
        }
    ...
    static public func validDOB(dob: String) -> (Bool,String) {
      
        guard dob.count > 0  else {
    ...
    static public func validethnicity(ethnicity: String) -> (Bool,String) {
      
        guard ethnicity.count > 0  else {
            return (false, "Please select ethnicity.")
        }
    ...
    static public func validateOldPassword(password:String?, val:String = "") -> (Bool,String) {
        ...
        guard pwd.count >= 8 else {
            return (false, "\(val)Password should be 8 characters long")
        }
        return (true,"Please enter valid \(val)password")
    }
